...
from Helpers.ChatUI import renderChatUI
import os
...
def main():
    ...
    if uploaded_file is not None:
        ...
        renderChatUI(index,text1,app.model)


        # st.session_state["pdf_text"] =  text1 # Store text in session state for later use
        # st.subheader("Extracted Text")
        # st.text_area("PDF Content", value=text1, height=300)
